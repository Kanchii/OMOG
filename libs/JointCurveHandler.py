...
class JointCurveHandler:
    ...
    def G1(self):
        ...
        hermite_vector = self.hermiteCurve.controlPointHandler.getValue(2).vet(self.hermiteCurve.controlPointHandler.getValue(3))
        ...
        self.nurbsCurve.controlPointHandler.control_points[1] = ControlPoint(nurbs_second_control_point.x,
                        ...
                        control_point_ant.real_radius,
                        control_point_ant.number,
                        control_point_ant.weight,
                        control_point_ant.terminal,
                        control_point_ant.real_color)
        
        print(self.nurbsCurve.controlPointHandler.control_points[1].pos)
